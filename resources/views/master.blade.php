  ...
  <br><br>
    ...
    <div class="container-fluid " >
        <div class="row filters mb-4">
          <form method="get" action="{{ url('/master') }}" >
            <div class="form-group" >
              {{-- <label for="lieu" class="mr-2 font-weight-bold">Lieu de formation :</label> --}}
            ...
            <div class="col-md-4" >
              <div class="card mb-4">
                <div class="card-body" style="height:200px">
                  ...
                  <a href="{{ route('showMaster', ['lieu' => $offre->lieu_formation]) }}" class="button">Show more</a>
